...
Buatkan 1 postingan media sosial untuk platform **${data.platform}** dengan topik:
"${data.topic}".

Gunakan gaya penulisan yang ${data.style.toLowerCase()}.
${data.includeEmoji ? "- Sertakan emoji secara natural, tidak berlebihan.\n" : "- Jangan sertakan emoji apapun dalam postingan.\n"}
${data.includeHashtag ? "- Sertakan hashtag relevan di akhir postingan.\n" : "- Jangan sertakan hashtag apapun dalam postingan.\n"}
Pastikan:
